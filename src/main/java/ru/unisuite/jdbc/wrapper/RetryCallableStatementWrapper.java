...
/**
 * Wrapper for java.sql.CallableStatement
 * this class overrides three methods: execute, executeQuery and executeUpdate
 * other methods are delegated
 */

class RetryCallableStatementWrapper extends RetryPreparedStatementWrapper implements CallableStatement {
    private Logger logger = Logger.getLogger(RetryCallableStatementWrapper.class.getName());

    private final CallableStatement callableStatement;
    private final SqlExecutor sqlExecutor;

    public RetryCallableStatementWrapper(CallableStatement statement, SqlExecutor sqlExecutor) {
        super(statement, sqlExecutor);
    ...
    public boolean execute() throws SQLException {
        return sqlExecutor.executeWithRetry(callableStatement::execute);
    }

    @Override
    public int executeUpdate() throws SQLException {
        return sqlExecutor.executeWithRetry(callableStatement::executeUpdate);
    }

    @Override
    public ResultSet executeQuery() throws SQLException {
        return sqlExecutor.executeWithRetry(callableStatement::executeQuery);
    }

    @Override
    public ResultSet executeQuery(String sql) throws SQLException {
        return sqlExecutor.executeWithRetry(() -> callableStatement.executeQuery(sql));
    }

    @Override
    public int executeUpdate(String sql) throws SQLException {
        return sqlExecutor.executeWithRetry(() -> callableStatement.executeUpdate(sql));
    }

    @Override
    public boolean execute(String sql) throws SQLException {
        return sqlExecutor.executeWithRetry(() -> callableStatement.execute(sql));
    }

    @Override
    public int executeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
        return sqlExecutor.executeWithRetry(() -> callableStatement.executeUpdate(sql, autoGeneratedKeys));
    }

    @Override
    public int executeUpdate(String sql, int[] columnIndexes) throws SQLException {
        return sqlExecutor.executeWithRetry(() -> callableStatement.executeUpdate(sql, columnIndexes));
    }

    @Override
    public int executeUpdate(String sql, String[] columnNames) throws SQLException {
        return sqlExecutor.executeWithRetry(() -> callableStatement.executeUpdate(sql, columnNames));
    }

    @Override
    public boolean execute(String sql, int autoGeneratedKeys) throws SQLException {
        return sqlExecutor.executeWithRetry(() -> callableStatement.execute(sql, autoGeneratedKeys));
    }

    @Override
    public boolean execute(String sql, int[] columnIndexes) throws SQLException {
        return sqlExecutor.executeWithRetry(() -> callableStatement.execute(sql, columnIndexes));
    }

    @Override
    public boolean execute(String sql, String[] columnNames) throws SQLException {
        return sqlExecutor.executeWithRetry(() -> callableStatement.execute(sql, columnNames));
    }
