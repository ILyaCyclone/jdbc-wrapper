...
public class MyCallableStatementWrapper extends MyPreparedStatementWrapper implements CallableStatement {
	...
	public int executeUpdate(String sql) throws SQLException {
		int result = 0;
		try {
			result = callableStatement.executeUpdate(sql);
		} catch (SQLException e) {
			logger.log(Level.WARNING, "code:" + e.getErrorCode() + ", sql state: " + e.getSQLState(), e);
			if (reExecutionRequired(e)) {
				logger.log(Level.INFO, "re-executing package ");
	...
	public int executeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
		int result = 0;
		try {
			result = callableStatement.executeUpdate(sql, autoGeneratedKeys);
		} catch (SQLException e) {
			logger.log(Level.WARNING, "code:" + e.getErrorCode() + ", sql state: " + e.getSQLState(), e);
			if (reExecutionRequired(e)) {
				logger.log(Level.INFO, "re-executing package ");
	...
	public int executeUpdate(String sql, int[] columnIndexes) throws SQLException {
		int result = 0;
		try {
			result = callableStatement.executeUpdate(sql, columnIndexes);
		} catch (SQLException e) {
			logger.log(Level.WARNING, "code:" + e.getErrorCode() + ", sql state: " + e.getSQLState(), e);
			if (reExecutionRequired(e)) {
				logger.log(Level.INFO, "re-executing package ");
	...
	public int executeUpdate(String sql, String[] columnNames) throws SQLException {
		int result = 0;
		try {
			result = callableStatement.executeUpdate(sql, columnNames);
		} catch (SQLException e) {
			logger.log(Level.WARNING, "code:" + e.getErrorCode() + ", sql state: " + e.getSQLState(), e);
			if (reExecutionRequired(e)) {
				logger.log(Level.INFO, "re-executing package ");
	...
	public boolean execute(String sql, int autoGeneratedKeys) throws SQLException {
		boolean result = true;
		try {
			result = callableStatement.execute(sql, autoGeneratedKeys);
		} catch (SQLException e) {
			logger.log(Level.WARNING, "code:" + e.getErrorCode() + ", sql state: " + e.getSQLState(), e);
			if (reExecutionRequired(e)) {
				logger.log(Level.INFO, "re-executing package ");
	...
	public boolean execute(String sql, int[] columnIndexes) throws SQLException {
		boolean result = true;
		try {
			result = callableStatement.execute(sql, columnIndexes);
		} catch (SQLException e) {
			logger.log(Level.WARNING, "code:" + e.getErrorCode() + ", sql state: " + e.getSQLState(), e);
			if (reExecutionRequired(e)) {
				logger.log(Level.INFO, "re-executing package ");
	...
	public boolean execute(String sql, String[] columnNames) throws SQLException {
		boolean result = true;
		try {
			result = callableStatement.execute(sql, columnNames);
		} catch (SQLException e) {
			logger.log(Level.WARNING, "code:" + e.getErrorCode() + ", sql state: " + e.getSQLState(), e);
			if (reExecutionRequired(e)) {
				logger.log(Level.INFO, "re-executing package ");
