...
/**
* delegator for CallableStatement class
...
class RetryCallableStatementWrapper extends RetryPreparedStatementWrapper implements CallableStatement {
	...
	public RetryCallableStatementWrapper(CallableStatement statement, RetryClause retryClause) {
		super(statement, retryClause);
	...
	public boolean execute() throws SQLException {
		try {
			...
			if (retryClause.retryRequired(e)) {
				...
				logger.log(Level.INFO, "retry method 'execute'");
				return callableStatement.execute();
			} else
				throw e;
		}
	...
	public int executeUpdate() throws SQLException {
		try {
			...
			if (retryClause.retryRequired(e)) {
				logger.log(Level.WARNING, "code:" + e.getErrorCode() + ", sql state: " + e.getSQLState(), e);
				logger.log(Level.INFO, "retry method 'executeUpdate'");
				return callableStatement.executeUpdate();
			} else
				throw e;
		}
	...
	public ResultSet executeQuery() throws SQLException {
		try {
			...
			if (retryClause.retryRequired(e)) {
				logger.log(Level.WARNING, "code:" + e.getErrorCode() + ", sql state: " + e.getSQLState(), e);
				logger.log(Level.INFO, "retry method 'executeQuery'");
				return callableStatement.executeQuery();
			} else
				throw e;
		}
